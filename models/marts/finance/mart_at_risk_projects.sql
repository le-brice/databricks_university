...
joined as (
    select
        ...
        -- Urgency score: outstanding value weighted by time elapsed.
    ...
    left join departments as d on ar.department_id = d.department_id
    left join employees as e on p.principal_investigator_id = e.employee_id
)
